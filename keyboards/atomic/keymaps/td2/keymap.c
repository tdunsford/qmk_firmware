...
[LAYER_QWERTY] = {
  ...
  { KC_LCTL, KC_LGUI, KC_NO,   KC_LALT, M_UPPER, KC_SPC,  KC_NO,   M_LOWER, KC_RALT, KC_NO,   KC_RGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  },
},
...
[LAYER_LOWER] = {
  ...
  { _______, _______, _______, _______, _______, KC_KP_0, KC_KP_0, M_LOWER, KC_RALT, KC_PDOT, KC_PENT, _______, _______, _______, _______ }
},
/* LAYER = LAYER_LOWER
  .--------------------------------------------------------------------------------------------------------------------------------------.
...
[LAYER_UPPER] = {
  ...
  { _______, _______, _______, _______, M_UPPER, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ }
},
